...
public class TitleEditor extends Activity implements View.OnClickListener {
     ...
     */
    public static final String EDIT_TITLE_ACTION = "com.example.jumpnote.android.action.EDIT_TITLE";
    ...
    protected void onPause() {
        ...
        values.put(JumpNoteContract.Notes.TITLE, mText.getText().toString());
